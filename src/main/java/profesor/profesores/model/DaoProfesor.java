...
public class DaoProfesor {
    ...
    public List<BeanProfesor> listProfesor() {
        List<BeanProfesor> listProfesores = new ArrayList<>();
    ...
    public boolean saveProfesor(BeanProfesor profesor){
        try {
    ...
    //------------------------------------------------------------------------------
    public BeanProfesor consultProfesor (int id){
        BeanProfesor profesor = null;
        try{
    ...
    //---------------------------------------------
    public boolean updateProfesor(BeanProfesor profesor){
        try {
